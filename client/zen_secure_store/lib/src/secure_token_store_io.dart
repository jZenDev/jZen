...
///
/// This is the `dart.library.io` branch of the seam in `secure_token_store.dart` — the only one
/// that actually constructs `FlutterSecureStorage`. See that file for why a web build gets a
