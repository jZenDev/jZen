...
void main() {
  testWidgets('navigation_native build is tolerated across platforms', (WidgetTester tester) async {
    final items = List<ZenNavigationItem>.generate(
      2,
      (i) => ZenNavigationItem(id: 'n$i', label: 'NItem $i', builder: (c) => Text('NContent $i')),
    );
